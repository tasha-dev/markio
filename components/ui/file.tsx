...
export default function File({name, content, active = false}:fileType):ReactNode {
    ...
    return (
        <li className={'block w-full'}>
            <button
                data-active={active}
                className={'flex w-full items-center gap-[10px] px-[20px] py-[10px] transition-all duration-500 dark:text-white text-black dark:hover:bg-white/20 hover:bg-black/20 dark:data-[active="true"]:bg-white/20 data-[active="true"]:bg-black/20'}
            >
