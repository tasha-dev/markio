                    ...
                    editor && (
                        <BubbleMenu
                            ...
                            <ToggleGroup type="multiple">
                                ...
                                <ToggleGroupItem onClick={() => editor.chain().focus().toggleBold().run()} value="bold"
                                                 aria-label="Toggle bold">
                                    <Bold className="h-4 w-4"/>
                                </ToggleGroupItem>
                                <ToggleGroupItem onClick={() => editor.chain().focus().toggleItalic().run()} value="italic"
                                ...
                                <ToggleGroupItem onClick={() => editor.chain().focus().toggleCodeBlock().run()}
                                                 value="underline" aria-label="Toggle underline">
